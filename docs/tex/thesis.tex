...
\includegraphics[scale=0.55, trim=0 0 0 2, clip=true] {features_shuttle.png}
\label{fig:indexes}
\begin{tabular}{l*{6}{c}r}
Test Type & AUC & Accuracy & Model Size (bytes)\\
\hline
Feature 1 Continuous Handler & 0.995 & 0.685 & 9,093,459\\
Feature 2 Continuous Handler & 0.993 & 0.682 & 9,103,841\\
Feature 3 Continuous Handler & 0.991 & 0.683 & 9,098,280\\
Feature 4 Continuous Handler & 0.993 & 0.681 & 9,103,047\\
Feature 5 Continuous Handler & 0.992 & 0.681 & 9,060,722\\
Feature 6 Continuous Handler & 0.858 & 0.837 & \\
Feature 7 Continuous Handler & 0.997 & 0.997 & 9,453,584\\
Feature 8 Continuous Handler & 0.858 & 0.837 & \\
Feature 9 Continuous Handler & 0.988 & 0.679 & \\
All Features using Continuous Handlers & 0.858 & 0.900 & 5,511,391\\
All Discrete Feature Handler & 0.858 & 0.837
\end{tabular}
\end{figure}
\clearpage
